...
const MainNavigation: FunctionComponent = () => {
  ...
  const onVerticalTabContainer1Click = useCallback(() => {
    navigate("/freight-fees");
  }, [navigate]);
        ...
        <div className={styles.frameParent}>
          <div className={styles.frameGroup}>
            <div className={styles.subtreeWrapper}>
              <button className={styles.subtree}>
          ...
          <div className={styles.component26Parent}>
            <div className={styles.component26}>
              <div className={styles.verticalTab2}>
                <img
                  className={styles.iconsolidviewGrid}
                  loading="lazy"
                  alt=""
                  src="/iconsolidviewgrid.svg"
                />
              ...
              <div
                className={styles.verticalTab3}
                onClick={onVerticalTabContainer1Click}
              >
                <img
                  className={styles.reactIconsririarrowupdownli}
                  loading="lazy"
                  alt=""
                  src="/reacticonsririarrowupdownline.svg"
                />
                      ...
                      <div className={styles.broswerControlBarParent}>
                        ...
                        <div className={styles.frameParent1}>
                              ...
                              <div className={styles.logoGroup}>
                                ...
                                <div className={styles.logoContainer}>
                                  <img
                                    ...
                                    src="/logo-9@2x.png"
                                  />
                                  <img className={styles.logoIcon10} alt="" />
                                </div>
                              </div>
                            </div>
                          ...
                          <div className={styles.broswerControlBar3}>
                            ...
                            <div className={styles.branchingPoint1} />
                            <div className={styles.branchingPoint2} />
                            <div className={styles.branchingPoint3} />
                            <div className={styles.branchingPoint4} />
